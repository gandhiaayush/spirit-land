...
from config import GEMINI_API_KEY, GEMINI_MODEL, GEMMA_MODEL, DW_CLASSES, GCP_PROJECT, GCP_LOCATION, get_credentials

warnings.filterwarnings("ignore", message=".*thought_signature.*")

_client = genai.Client(vertexai=True, project=GCP_PROJECT, location="global", credentials=get_credentials())
